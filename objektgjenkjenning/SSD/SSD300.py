...
# Definer en ordbok for å mappe klasse-IDer til klassenavn
...
while True:
    ...
    print(
        print(f"Speed: {preprocess_time:.1f}ms preprocess, {inference_time:.1f}ms inference, {postprocess_time:.1f}ms postprocess per image at shape (1, {image.shape[0]}, {image.shape[1]}, {image.shape[2]})"))
    print()
